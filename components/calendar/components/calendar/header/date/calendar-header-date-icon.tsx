...
export default function CalendarHeaderDateIcon() {
  ...
  return (
    <div className="flex size-14 flex-col items-start overflow-hidden rounded-lg border">
      <p className="flex h-6 w-full items-center justify-center bg-primary text-center text-xs font-semibold text-white dark:text-black bg:text-black uppercase">
        {format(date, 'MMM')}
      </p>
