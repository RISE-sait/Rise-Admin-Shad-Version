...
export const columnsStaff: ColumnDef<User>[] = [
  ...
  },
  {
    ...
    id: "Role",
    // Use accessorFn because Role is nested under StaffInfo.
    accessorFn: (row) => row.StaffInfo?.Role ?? "",
    // Header renders a button (currently no sorting logic provided).
    header: ({ column }) => (
      <Button
        variant="ghost"
        onClick={() => {}}
    ...
    // Minimum and default width for Role column.
    minSize: 150,
    size: 180,
  },
  {
  ...
  },
  {
    ...
    accessorFn: (row) => (row.StaffInfo?.IsActive ? "Active" : "Inactive"),
