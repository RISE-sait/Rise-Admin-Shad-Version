            ...
            <TableBody>
              {loading ? (
                ...
                paginatedData.map((staff) => (
                  <TableRow
                    key={staff.ID}
                    className={`border-b hover:bg-muted/100 transition-colors duration-150 ease-in-out even:bg-muted/50 cursor-pointer ${selectedIds.includes(staff.ID) ? 'bg-muted' : ''}`}
                  ...
                  >
                    ...
                    <TableCell className="px-6 py-4 text-sm">
                      <Badge
                        variant={staff.StaffInfo!.IsActive ? 'default' : 'destructive'}
        ...
        <div className="bg-muted/30 px-6 py-4 border-t rounded-b-xl">
          <div className="flex items-center justify-between">
            <div className="text-sm text-muted-foreground">
              ...
              of{' '}
              <span className="font-semibold">{sortedData.length}</span> staff members
