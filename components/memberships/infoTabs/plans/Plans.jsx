...
export default function PlansTab({RenderPlans, MembershipID, refreshPlans }) {
    ...
    // states
    const [toggledPlanId, setToggledPlanId] = useState(null);
    const [editablePlans, setEditablePlans] = useState({});
    const [newperiod, setnewperiod] = useState()
    const [newname, setnewname] = useState()
    const [newstripeid, setnewstripeid] = useState()
    const [newstripejoinfee, setnewstripejoinfee] = useState()
    ...
    const handleTogglePlan = (planId) => {
        if (toggledPlanId === planId) {
            ...
            setEditablePlans(prev => ({
                ...prev,
                [planId]: RenderPlans.find(p => p.id === planId)
            }));
        }
    };
                            ...
                            <div className="p-2">
                                ...
                                <div className="pt-3 flex" >
                                    ...
                                    <div className="w-full pl-1 " >
                                        ...
                                        <Input className="w-full mt-1" onChange={(e) => handleInputChange(plan.id, "amt_periods", e.target.value)} value={editablePlans[plan.id]?.amt_periods || ""} placeholder={plan.amt_periods} onClick={(e) => e.stopPropagation()}/>
                                    </div>
                                </div>
