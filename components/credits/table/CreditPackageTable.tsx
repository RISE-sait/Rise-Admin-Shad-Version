...
interface CreditPackageTableProps {
  ...
  onCreditPackageSelect: (creditPackage: CreditPackage) => void;
...
export default function CreditPackageTable({
  creditPackages,
          ...
          <TableBody>
            {isRefreshing ? (
              <TableRow>
                ...
                >
                  <div className="flex flex-col items-center space-y-2">
                    ...
                    <span>Refreshing credit packages...</span>
                  </div>
                </TableCell>
              </TableRow>
              ...
              table.getRowModel().rows.map((row) => (
                <TableRow
                  key={row.id}
                  onClick={() => onCreditPackageSelect(row.original)}
              ...
              <TableRow>
                ...
                >
                  <div className="flex flex-col items-center space-y-2">
                    ...
                    <span>No credit packages found</span>
                  </div>
                </TableCell>
              </TableRow>
            )}
